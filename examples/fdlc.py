...
and establishing version control foundation.
    ...
    # Ensure Registry client for version control
    log.info("Ensuring Registry client...")
    nipyapi.versioning.ensure_registry_client(
...
This makes the flow live in the production environment.
    ...
    prod_registry_client = nipyapi.versioning.ensure_registry_client(
