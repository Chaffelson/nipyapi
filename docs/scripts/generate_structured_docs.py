...
def generate_examples_docs(output_dir):
    ...
    content += "Playground Environment\n"
    content += "---------------------\n\n"
    content += "For quick experimentation, use the playground make target to set up a ready-to-use environment:\n\n"
    content += ".. code-block:: console\n\n"
    content += "    $ make playground NIPYAPI_AUTH_MODE=single-user     # Recommended - simple setup\n"
    content += "    $ make playground NIPYAPI_AUTH_MODE=secure-ldap     # LDAP authentication\n"
    content += "    $ make playground NIPYAPI_AUTH_MODE=secure-mtls     # Certificate authentication (advanced)\n\n"
    content += "The playground automatically creates:\n\n"
