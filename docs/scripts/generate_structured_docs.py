...
def generate_examples_docs(output_dir):
    ...
    content += "    $ make sandbox NIPYAPI_AUTH_MODE=single-user     # Recommended - simple setup\n"
    content += "    $ make sandbox NIPYAPI_AUTH_MODE=secure-ldap     # LDAP authentication\n"
    content += "    $ make sandbox NIPYAPI_AUTH_MODE=secure-mtls     # Certificate authentication (advanced)\n\n"
