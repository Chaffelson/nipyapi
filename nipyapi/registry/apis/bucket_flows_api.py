...
class BucketFlowsApi(object):
    ...
    def create_flow(self, bucket_id, **kwargs):
        """
        Creates a flow
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_flow(bucket_id, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.create_flow_with_http_info(bucket_id, **kwargs)
        else:
            (data) = self.create_flow_with_http_info(bucket_id, **kwargs)
            return data

    def create_flow_with_http_info(self, bucket_id, **kwargs):
        """
        Creates a flow
        The flow id is created by the server and populated in the returned entity.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_flow_with_http_info(bucket_id, callback=callback_function)
    ...
    def create_flow_version(self, bucket_id, flow_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_flow_version(bucket_id, flow_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_flow_version_with_http_info(bucket_id, flow_id, **kwargs)
        else:
            (data) = self.create_flow_version_with_http_info(bucket_id, flow_id, **kwargs)
            return data

    def create_flow_version_with_http_info(self, bucket_id, flow_id, **kwargs):
        """
        Creates the next version of a flow
        The version number is created by the server and populated in the returned entity.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_flow_version_with_http_info(bucket_id, flow_id, callback=callback_function)
    ...
    def update_flow(self, bucket_id, flow_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_flow(bucket_id, flow_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_flow_with_http_info(bucket_id, flow_id, **kwargs)
        else:
            (data) = self.update_flow_with_http_info(bucket_id, flow_id, **kwargs)
            return data
    ...
    def update_flow_with_http_info(self, bucket_id, flow_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_flow_with_http_info(bucket_id, flow_id, callback=callback_function)
