...
class VersionedListenPortDefinition(object):
    """
...
'transport_protocol': 'transportProtocol'    }
    ...
    def application_protocols(self):
        """
        Gets the application_protocols of this VersionedListenPortDefinition.
        The application protocol(s) that the listen port could support (if any)

        :return: The application_protocols of this VersionedListenPortDefinition.
        :rtype: list[str]
        """
    ...
    def application_protocols(self, application_protocols):
        """
        Sets the application_protocols of this VersionedListenPortDefinition.
        The application protocol(s) that the listen port could support (if any)

        :param application_protocols: The application_protocols of this VersionedListenPortDefinition.
        :type: list[str]
        """
    ...
    def transport_protocol(self):
        """
        Gets the transport_protocol of this VersionedListenPortDefinition.
        The transport protocol used by the listen port

        :return: The transport_protocol of this VersionedListenPortDefinition.
        :rtype: str
        """
    ...
    def transport_protocol(self, transport_protocol):
        """
        Sets the transport_protocol of this VersionedListenPortDefinition.
        The transport protocol used by the listen port

        :param transport_protocol: The transport_protocol of this VersionedListenPortDefinition.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, VersionedListenPortDefinition):
            return False
