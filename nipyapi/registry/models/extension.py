...
'writes_attributes': 'writesAttributes'    }
    ...
    def configuration_steps(self):
        """
        Gets the configuration_steps of this Extension.
        The configuration steps for a Connector extension

        :return: The configuration_steps of this Extension.
    ...
    def configuration_steps(self, configuration_steps):
        """
        Sets the configuration_steps of this Extension.
        The configuration steps for a Connector extension

        :param configuration_steps: The configuration_steps of this Extension.
    ...
    def reads_attributes(self):
        ...
        The attributes read from FlowFiles by the extension
    ...
    def trigger_when_any_destination_available(self):
        ...
        Indicates that a processor should be triggered when any destinations have space for FlowFiles
    ...
    def type(self, type):
        ...
        allowed_values = ["PROCESSOR", "CONTROLLER_SERVICE", "REPORTING_TASK", "FLOW_ANALYSIS_RULE", "PARAMETER_PROVIDER", "FLOW_REGISTRY_CLIENT", "CONNECTOR", ]
    ...
    def writes_attributes(self):
        ...
        The attributes written to FlowFiles by the extension
