...
'bundle': 'Bundle',
'comments': 'str',
'component_state': 'VersionedComponentState',
'component_type': 'str',
...
'type': 'type'    }
    ...
    def __init__(self, annotation_data=None, bulletin_level=None, bundle=None, comments=None, component_state=None, component_type=None, controller_service_apis=None, group_identifier=None, identifier=None, instance_identifier=None, name=None, position=None, properties=None, property_descriptors=None, scheduled_state=None, type=None):
        """
    ...
    def component_state(self):
        """
        Gets the component_state of this VersionedControllerService.

        :return: The component_state of this VersionedControllerService.
        :rtype: VersionedComponentState
        """
    ...
    def component_state(self, component_state):
        """
        Sets the component_state of this VersionedControllerService.

        :param component_state: The component_state of this VersionedControllerService.
        :type: VersionedComponentState
        """
    ...
    def component_type(self, component_type):
        ...
        :type: str
        """
        allowed_values = ["CONNECTION", "PROCESSOR", "PROCESS_GROUP", "REMOTE_PROCESS_GROUP", "INPUT_PORT", "OUTPUT_PORT", "REMOTE_INPUT_PORT", "REMOTE_OUTPUT_PORT", "FUNNEL", "LABEL", "CONTROLLER_SERVICE", "REPORTING_TASK", "FLOW_ANALYSIS_RULE", "PARAMETER_CONTEXT", "PARAMETER_PROVIDER", "FLOW_REGISTRY_CLIENT", "CONNECTOR", ]
