...
'revision': 'revision'    }
    ...
    def __init__(self, allow_bundle_redeploy=None, allow_public_read=None, created_timestamp=None, description=None, identifier=None, link=None, name=None, permissions=None, revision=None):
        """
