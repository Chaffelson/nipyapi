...
class VersionedPort(object):
    ...
    def __init__(self, identifier=None, name=None, comments=None, position=None, type=None, concurrently_schedulable_task_count=None, scheduled_state=None, allow_remote_access=None, component_type=None, group_identifier=None):
        """
