...
'type': 'type'    }
    ...
    def __init__(self, bucket_identifier=None, bucket_name=None, created_timestamp=None, description=None, identifier=None, link=None, modified_timestamp=None, name=None, permissions=None, type=None):
        """
