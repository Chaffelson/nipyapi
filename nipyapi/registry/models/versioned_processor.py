...
'yield_duration': 'yieldDuration'    }
    ...
    def __init__(self, annotation_data=None, auto_terminated_relationships=None, backoff_mechanism=None, bulletin_level=None, bundle=None, comments=None, component_state=None, component_type=None, concurrently_schedulable_task_count=None, execution_node=None, group_identifier=None, identifier=None, instance_identifier=None, max_backoff_period=None, name=None, penalty_duration=None, position=None, properties=None, property_descriptors=None, retried_relationships=None, retry_count=None, run_duration_millis=None, scheduled_state=None, scheduling_period=None, scheduling_strategy=None, style=None, type=None, yield_duration=None):
        """
    ...
    def component_state(self):
        """
        Gets the component_state of this VersionedProcessor.

        :return: The component_state of this VersionedProcessor.
    ...
    def component_state(self, component_state):
        """
        Sets the component_state of this VersionedProcessor.

        :param component_state: The component_state of this VersionedProcessor.
