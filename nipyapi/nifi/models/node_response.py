...
class NodeResponse(object):
    ...
    def __init__(self, http_method=None, request_uri=None, response=None, node_id=None, throwable=None, updated_entity=None, request_id=None, client_response=None, is2xx=None, is5xx=None, input_stream=None, status=None):
        """
