...
'source_name': 'sourceName'    }
    ...
    def __init__(self, bytes_in=None, bytes_out=None, bytes_queued=None, destination_id=None, destination_name=None, flow_file_availability=None, flow_files_in=None, flow_files_out=None, flow_files_queued=None, group_id=None, id=None, input=None, load_balance_status=None, name=None, output=None, percent_use_bytes=None, percent_use_count=None, predictions=None, queued=None, queued_count=None, queued_size=None, source_id=None, source_name=None):
        """
    ...
    def load_balance_status(self):
        """
        Gets the load_balance_status of this ConnectionStatusSnapshotDTO.
        The load balance status of the connection

        :return: The load_balance_status of this ConnectionStatusSnapshotDTO.
        :rtype: str
        """
    ...
    def load_balance_status(self, load_balance_status):
        """
        Sets the load_balance_status of this ConnectionStatusSnapshotDTO.
        The load balance status of the connection

        :param load_balance_status: The load_balance_status of this ConnectionStatusSnapshotDTO.
        :type: str
        """
        allowed_values = ["LOAD_BALANCE_NOT_CONFIGURED", "LOAD_BALANCE_ACTIVE", "LOAD_BALANCE_INACTIVE", ]
