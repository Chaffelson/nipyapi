...
'type': 'type'    }
    ...
    def __init__(self, annotation_data=None, bundle=None, comments=None, component_state=None, component_type=None, group_identifier=None, identifier=None, instance_identifier=None, name=None, position=None, properties=None, property_descriptors=None, scheduled_state=None, scheduling_period=None, scheduling_strategy=None, type=None):
        """
    ...
    def component_state(self):
        """
        Gets the component_state of this VersionedReportingTask.

        :return: The component_state of this VersionedReportingTask.
    ...
    def component_state(self, component_state):
        """
        Sets the component_state of this VersionedReportingTask.

        :param component_state: The component_state of this VersionedReportingTask.
