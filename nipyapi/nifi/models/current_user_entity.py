...
'connectors_permissions': 'PermissionsDTO',
...
'connectors_permissions': 'connectorsPermissions',
...
'tenants_permissions': 'tenantsPermissions'    }
    ...
    def __init__(self, anonymous=None, can_version_flows=None, component_restriction_permissions=None, connectors_permissions=None, controller_permissions=None, counters_permissions=None, identity=None, logout_supported=None, parameter_context_permissions=None, policies_permissions=None, provenance_permissions=None, restricted_components_permissions=None, system_permissions=None, tenants_permissions=None):
        """
        ...
        self._connectors_permissions = None
        ...
        if connectors_permissions is not None:
          self.connectors_permissions = connectors_permissions
    ...
    @property
    def connectors_permissions(self):
        """
        Gets the connectors_permissions of this CurrentUserEntity.

        :return: The connectors_permissions of this CurrentUserEntity.
        :rtype: PermissionsDTO
        """
        return self._connectors_permissions

    @connectors_permissions.setter
    def connectors_permissions(self, connectors_permissions):
        """
        Sets the connectors_permissions of this CurrentUserEntity.

        :param connectors_permissions: The connectors_permissions of this CurrentUserEntity.
        :type: PermissionsDTO
        """

        self._connectors_permissions = connectors_permissions
