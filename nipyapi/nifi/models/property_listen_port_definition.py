...
class PropertyListenPortDefinition(object):
    """
...
'transport_protocol': 'transportProtocol'    }
    ...
    def __init__(self, application_protocols=None, transport_protocol=None):
        """
        PropertyListenPortDefinition - a model defined in Swagger
        """
    ...
    def application_protocols(self):
        """
        Gets the application_protocols of this PropertyListenPortDefinition.
        The application protocols that this listen port could support (if any)

        :return: The application_protocols of this PropertyListenPortDefinition.
        :rtype: list[str]
        """
    ...
    def application_protocols(self, application_protocols):
        """
        Sets the application_protocols of this PropertyListenPortDefinition.
        The application protocols that this listen port could support (if any)

        :param application_protocols: The application_protocols of this PropertyListenPortDefinition.
        :type: list[str]
        """
    ...
    def transport_protocol(self):
        """
        Gets the transport_protocol of this PropertyListenPortDefinition.
        The transport protocol used by this listen port

        :return: The transport_protocol of this PropertyListenPortDefinition.
        :rtype: str
        """
    ...
    def transport_protocol(self, transport_protocol):
        """
        Sets the transport_protocol of this PropertyListenPortDefinition.
        The transport protocol used by this listen port

        :param transport_protocol: The transport_protocol of this PropertyListenPortDefinition.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PropertyListenPortDefinition):
            return False
