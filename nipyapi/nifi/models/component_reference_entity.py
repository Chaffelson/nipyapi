...
'uri': 'uri'    }
    ...
    def __init__(self, bulletins=None, component=None, disconnected_node_acknowledged=None, id=None, parent_group_id=None, permissions=None, position=None, revision=None, uri=None):
        """
