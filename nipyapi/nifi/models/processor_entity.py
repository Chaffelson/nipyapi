...
'uri': 'uri'    }
    ...
    def __init__(self, bulletins=None, component=None, disconnected_node_acknowledged=None, id=None, input_requirement=None, operate_permissions=None, permissions=None, physical_state=None, position=None, revision=None, status=None, uri=None):
        """
    ...
    def physical_state(self):
        """
        Gets the physical_state of this ProcessorEntity.
        The physical state of the processor, including transition states

        :return: The physical_state of this ProcessorEntity.
        :rtype: str
        """
    ...
    def physical_state(self, physical_state):
        """
        Sets the physical_state of this ProcessorEntity.
        The physical state of the processor, including transition states

        :param physical_state: The physical_state of this ProcessorEntity.
        :type: str
        """
