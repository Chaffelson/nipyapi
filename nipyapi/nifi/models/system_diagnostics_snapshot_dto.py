...
'resource_claim_details': 'list[ResourceClaimDetailsDTO]',
...
'resource_claim_details': 'resourceClaimDetails',
...
'version_info': 'versionInfo'    }
    ...
    def __init__(self, available_processors=None, content_repository_storage_usage=None, daemon_threads=None, flow_file_repository_storage_usage=None, free_heap=None, free_heap_bytes=None, free_non_heap=None, free_non_heap_bytes=None, garbage_collection=None, heap_utilization=None, max_heap=None, max_heap_bytes=None, max_non_heap=None, max_non_heap_bytes=None, non_heap_utilization=None, processor_load_average=None, provenance_repository_storage_usage=None, resource_claim_details=None, stats_last_refreshed=None, total_heap=None, total_heap_bytes=None, total_non_heap=None, total_non_heap_bytes=None, total_threads=None, uptime=None, used_heap=None, used_heap_bytes=None, used_non_heap=None, used_non_heap_bytes=None, version_info=None):
        ...
        self._resource_claim_details = None
        ...
        if resource_claim_details is not None:
          self.resource_claim_details = resource_claim_details
    ...
    @property
    def resource_claim_details(self):
        """
        Gets the resource_claim_details of this SystemDiagnosticsSnapshotDTO.

        :return: The resource_claim_details of this SystemDiagnosticsSnapshotDTO.
        :rtype: list[ResourceClaimDetailsDTO]
        """
        return self._resource_claim_details

    @resource_claim_details.setter
    def resource_claim_details(self, resource_claim_details):
        """
        Sets the resource_claim_details of this SystemDiagnosticsSnapshotDTO.

        :param resource_claim_details: The resource_claim_details of this SystemDiagnosticsSnapshotDTO.
        :type: list[ResourceClaimDetailsDTO]
        """

        self._resource_claim_details = resource_claim_details
