...
class SearchResultsDTO(object):
    ...
    def __init__(self, processor_results=None, connection_results=None, process_group_results=None, input_port_results=None, output_port_results=None, remote_process_group_results=None, funnel_results=None, parameter_context_results=None, parameter_results=None):
        """
