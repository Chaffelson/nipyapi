...
'type': 'type'    }
    ...
    def __init__(self, child_uuids=None, cluster_node_identifier=None, event_type=None, flow_file_uuid=None, id=None, millis=None, parent_uuids=None, timestamp=None, type=None):
        """
