...
'version': 'version'    }
    ...
    def __init__(self, build_branch=None, build_revision=None, build_tag=None, build_timestamp=None, content_viewer_url=None, timezone=None, title=None, uri=None, version=None):
        """
