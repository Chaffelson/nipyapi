...
'versioned_flow_state': 'versionedFlowState'    }
    ...
    def process_group_update_strategy(self, process_group_update_strategy):
        ...
        :type: str
        """
        allowed_values = ["CURRENT_GROUP", "CURRENT_GROUP_WITH_CHILDREN", ]
