...
'reporting_task_types': 'reportingTaskTypes'    }
    ...
    def __init__(self, connector_types=None, controller_service_types=None, dependent_coordinates=None, flow_analysis_rule_types=None, flow_registry_client_types=None, nar_summary=None, parameter_provider_types=None, processor_types=None, reporting_task_types=None):
        """
    ...
    def connector_types(self):
        """
        Gets the connector_types of this NarDetailsEntity.
        The Connector types contained in the NAR

        :return: The connector_types of this NarDetailsEntity.
    ...
    def connector_types(self, connector_types):
        """
        Sets the connector_types of this NarDetailsEntity.
        The Connector types contained in the NAR

        :param connector_types: The connector_types of this NarDetailsEntity.
