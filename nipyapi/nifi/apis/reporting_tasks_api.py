...
class ReportingTasksApi(object):
    ...
    def clear_bulletins7(self, body, id, **kwargs):
        """
        Clears bulletins for a reporting task.
        This method makes a synchronous HTTP request and returns the response data directly.
        
        For full HTTP response details (status code, headers, etc.), use the corresponding 
        ``clear_bulletins7_with_http_info()`` method instead.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.clear_bulletins7_with_http_info(body, id, **kwargs)
        else:
            (data) = self.clear_bulletins7_with_http_info(body, id, **kwargs)
            return data

    def clear_bulletins7_with_http_info(self, body, id, **kwargs):
        """
        Clears bulletins for a reporting task.
        This method makes a synchronous HTTP request and returns detailed response information.
        
        Returns the response data along with HTTP status code, headers, and other metadata.
        For just the response data, use the corresponding ``clear_bulletins7()`` method instead.
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method clear_bulletins7" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `clear_bulletins7`")
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `clear_bulletins7`")
        ...
        return self.api_client.call_api('/reporting-tasks/{id}/bulletins/clear-requests', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_run_status6(self, body, id, **kwargs):
        """
        Updates run status of a reporting task.
        This method makes a synchronous HTTP request and returns the response data directly.
        
        For full HTTP response details (status code, headers, etc.), use the corresponding 
        ``update_run_status6_with_http_info()`` method instead.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_run_status6_with_http_info(body, id, **kwargs)
        else:
            (data) = self.update_run_status6_with_http_info(body, id, **kwargs)
            return data

    def update_run_status6_with_http_info(self, body, id, **kwargs):
        """
        Updates run status of a reporting task.
        This method makes a synchronous HTTP request and returns detailed response information.
        
        Returns the response data along with HTTP status code, headers, and other metadata.
        For just the response data, use the corresponding ``update_run_status6()`` method instead.
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_run_status6" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_run_status6`")
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_run_status6`")
