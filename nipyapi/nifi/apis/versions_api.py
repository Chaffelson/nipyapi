...
class VersionsApi(object):
    ...
    def create_flow_branch(self, body, id, **kwargs):
        """
        Creates a new branch for a version controlled Process Group.
        ...
        ``create_flow_branch_with_http_info()`` method instead.
        
        Args:
            body (:class:`~nipyapi.nifi.models.CreateFlowBranchRequestEntity`): 
                The branch creation request. (required)
            id (str): 
        ...
        if kwargs.get('callback'):
            return self.create_flow_branch_with_http_info(body, id, **kwargs)
        else:
            (data) = self.create_flow_branch_with_http_info(body, id, **kwargs)
            return data

    def create_flow_branch_with_http_info(self, body, id, **kwargs):
        """
        Creates a new branch for a version controlled Process Group.
        ...
        For just the response data, use the corresponding ``create_flow_branch()`` method instead.
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_flow_branch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_flow_branch`")
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `create_flow_branch`")
        ...
        return self.api_client.call_api('/versions/process-groups/{id}/branches', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
