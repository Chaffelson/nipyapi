...
class ParameterContextsApi(object):
    ...
    def create_asset1(self, body, context_id, **kwargs):
        """
        ...
        ``create_asset1_with_http_info()`` method instead.
        ...
        if kwargs.get('callback'):
            return self.create_asset1_with_http_info(body, context_id, **kwargs)
        else:
            (data) = self.create_asset1_with_http_info(body, context_id, **kwargs)
            return data

    def create_asset1_with_http_info(self, body, context_id, **kwargs):
        """
        Creates a new Asset in the given Parameter Context.
        ...
        For just the response data, use the corresponding ``create_asset1()`` method instead.
        ...
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_asset1`")
        # verify the required parameter 'context_id' is set
        if ('context_id' not in params) or (params['context_id'] is None):
            raise ValueError("Missing the required parameter `context_id` when calling `create_asset1`")
    ...
    def get_asset_content1(self, context_id, asset_id, **kwargs):
        """
        Retrieves the content of the asset with the given id.
        This method makes a synchronous HTTP request and returns the response data directly.
        
        For full HTTP response details (status code, headers, etc.), use the corresponding 
        ``get_asset_content1_with_http_info()`` method instead.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_asset_content1_with_http_info(context_id, asset_id, **kwargs)
        else:
            (data) = self.get_asset_content1_with_http_info(context_id, asset_id, **kwargs)
            return data

    def get_asset_content1_with_http_info(self, context_id, asset_id, **kwargs):
        """
        Retrieves the content of the asset with the given id.
        This method makes a synchronous HTTP request and returns detailed response information.
        
        Returns the response data along with HTTP status code, headers, and other metadata.
        For just the response data, use the corresponding ``get_asset_content1()`` method instead.
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_asset_content1" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'context_id' is set
        if ('context_id' not in params) or (params['context_id'] is None):
            raise ValueError("Missing the required parameter `context_id` when calling `get_asset_content1`")
        # verify the required parameter 'asset_id' is set
        if ('asset_id' not in params) or (params['asset_id'] is None):
            raise ValueError("Missing the required parameter `asset_id` when calling `get_asset_content1`")
    ...
    def get_assets1(self, context_id, **kwargs):
        """
        Lists the assets that belong to the Parameter Context with the given ID..
        This method makes a synchronous HTTP request and returns the response data directly.
        
        For full HTTP response details (status code, headers, etc.), use the corresponding 
        ``get_assets1_with_http_info()`` method instead.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_assets1_with_http_info(context_id, **kwargs)
        else:
            (data) = self.get_assets1_with_http_info(context_id, **kwargs)
            return data

    def get_assets1_with_http_info(self, context_id, **kwargs):
        """
        Lists the assets that belong to the Parameter Context with the given ID..
        This method makes a synchronous HTTP request and returns detailed response information.
        
        Returns the response data along with HTTP status code, headers, and other metadata.
        For just the response data, use the corresponding ``get_assets1()`` method instead.
        ...
        # verify the required parameter 'context_id' is set
        if ('context_id' not in params) or (params['context_id'] is None):
            raise ValueError("Missing the required parameter `context_id` when calling `get_assets1`")
