...
class CountersApi(object):
    ...
    def update_all_counters(self, **kwargs):
        """
        ...
        For full HTTP response details (status code, headers, etc.), use the corresponding 
        ``update_all_counters_with_http_info()`` method instead.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_all_counters_with_http_info(**kwargs)
        else:
            (data) = self.update_all_counters_with_http_info(**kwargs)
            return data

    def update_all_counters_with_http_info(self, **kwargs):
        """
        Updates all counters. This will reset all counter values to 0.
        ...
        Returns the response data along with HTTP status code, headers, and other metadata.
        For just the response data, use the corresponding ``update_all_counters()`` method instead.
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_all_counters" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/counters', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
