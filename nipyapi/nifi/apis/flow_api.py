...
class FlowApi(object):
    ...
    def clear_bulletins1(self, body, id, **kwargs):
        """
        Clears bulletins for components in the specified Process Group..
        This method makes a synchronous HTTP request and returns the response data directly.
        
        For full HTTP response details (status code, headers, etc.), use the corresponding 
        ``clear_bulletins1_with_http_info()`` method instead.
        
        Args:
            body (:class:`~nipyapi.nifi.models.ClearBulletinsForGroupRequestEntity`): 
                The request to clear bulletins. If the components in the request are not specified, all authorized components will be considered. (required)
            id (str): 
                The process group id. (required)
                
        Returns:
            :class:`~nipyapi.nifi.models.ClearBulletinsForGroupResultsEntity`: The response data.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.clear_bulletins1_with_http_info(body, id, **kwargs)
        else:
            (data) = self.clear_bulletins1_with_http_info(body, id, **kwargs)
            return data

    def clear_bulletins1_with_http_info(self, body, id, **kwargs):
        """
        Clears bulletins for components in the specified Process Group..
        This method makes a synchronous HTTP request and returns detailed response information.
        
        Returns the response data along with HTTP status code, headers, and other metadata.
        For just the response data, use the corresponding ``clear_bulletins1()`` method instead.
        ...
        Returns:
            tuple: (:class:`~nipyapi.nifi.models.ClearBulletinsForGroupResultsEntity`, status_code, headers) - Response data with HTTP details.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method clear_bulletins1" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `clear_bulletins1`")
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `clear_bulletins1`")
        ...
        return self.api_client.call_api('/flow/process-groups/{id}/bulletins/clear-requests', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ClearBulletinsForGroupResultsEntity',
                                        auth_settings=auth_settings,
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
    ...
    def get_bulletin_board(self, **kwargs):
        ...
        Args:
            ...
            limit (:class:`~nipyapi.nifi.models.IntegerParameter`): 
                The number of bulletins to limit the response to. Optional, default is no limit.
    ...
    def get_connector_definition(self, group, artifact, version, type, **kwargs):
        """
        ...
        For full HTTP response details (status code, headers, etc.), use the corresponding 
        ``get_connector_definition_with_http_info()`` method instead.
        ...
        Args:
            ...
            version (str): 
                The bundle version (required)
            type (str): 
                The connector type (required)
                
        Returns:
            :class:`~nipyapi.nifi.models.ConnectorDefinition`: The response data.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_connector_definition_with_http_info(group, artifact, version, type, **kwargs)
        else:
            (data) = self.get_connector_definition_with_http_info(group, artifact, version, type, **kwargs)
            return data

    def get_connector_definition_with_http_info(self, group, artifact, version, type, **kwargs):
        """
        Retrieves the Connector Definition for the specified component type..
        ...
        Returns the response data along with HTTP status code, headers, and other metadata.
        For just the response data, use the corresponding ``get_connector_definition()`` method instead.
        ...
        Returns:
            tuple: (:class:`~nipyapi.nifi.models.ConnectorDefinition`, status_code, headers) - Response data with HTTP details.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_connector_definition" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'group' is set
        if ('group' not in params) or (params['group'] is None):
            raise ValueError("Missing the required parameter `group` when calling `get_connector_definition`")
        # verify the required parameter 'artifact' is set
        if ('artifact' not in params) or (params['artifact'] is None):
            raise ValueError("Missing the required parameter `artifact` when calling `get_connector_definition`")
        # verify the required parameter 'version' is set
        if ('version' not in params) or (params['version'] is None):
            raise ValueError("Missing the required parameter `version` when calling `get_connector_definition`")
        # verify the required parameter 'type' is set
        if ('type' not in params) or (params['type'] is None):
            raise ValueError("Missing the required parameter `type` when calling `get_connector_definition`")
        ...
        return self.api_client.call_api('/flow/connector-definition/{group}/{artifact}/{version}/{type}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ConnectorDefinition',
                                        auth_settings=auth_settings,
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
    ...
    def get_connector_types(self, **kwargs):
        ...
        For full HTTP response details (status code, headers, etc.), use the corresponding 
        ``get_connector_types_with_http_info()`` method instead.
        ...
        Returns:
            :class:`~nipyapi.nifi.models.ConnectorTypesEntity`: The response data.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_connector_types_with_http_info(**kwargs)
        else:
            (data) = self.get_connector_types_with_http_info(**kwargs)
            return data

    def get_connector_types_with_http_info(self, **kwargs):
        """
        Retrieves the types of connectors that this NiFi supports.
        ...
        Returns the response data along with HTTP status code, headers, and other metadata.
        For just the response data, use the corresponding ``get_connector_types()`` method instead.
        ...
        Returns:
            tuple: (:class:`~nipyapi.nifi.models.ConnectorTypesEntity`, status_code, headers) - Response data with HTTP details.
        """
        ...
        return self.api_client.call_api('/flow/connector-types', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ConnectorTypesEntity',
                                        auth_settings=auth_settings,
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
    ...
    def get_connectors(self, **kwargs):
        ...
        For full HTTP response details (status code, headers, etc.), use the corresponding 
        ``get_connectors_with_http_info()`` method instead.
        
        Args:
                
        Returns:
            :class:`~nipyapi.nifi.models.ConnectorsEntity`: The response data.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
    ...
    def get_connectors_with_http_info(self, **kwargs):
        ...
        Returns the response data along with HTTP status code, headers, and other metadata.
        For just the response data, use the corresponding ``get_connectors()`` method instead.
        
        Args:
                
        Returns:
            tuple: (:class:`~nipyapi.nifi.models.ConnectorsEntity`, status_code, headers) - Response data with HTTP details.
        """
        ...
        return self.api_client.call_api('/flow/connectors', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ConnectorsEntity',
                                        auth_settings=auth_settings,
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
    ...
    def get_controller_services_from_controller_with_http_info(self, **kwargs):
        ...
        all_params = ['include_referencing_components', 'ui_only']
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_flow1(self, id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_flow1_with_http_info(id, **kwargs)
        else:
            (data) = self.get_flow1_with_http_info(id, **kwargs)
            return data

    def get_flow1_with_http_info(self, id, **kwargs):
        """
        Gets a process group.
        ...
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_flow1`")
    ...
    def get_flow_metrics(self, producer, **kwargs):
        ...
        Args:
            ...
            flow_metrics_reporting_strategy (str): 
                Flow metrics reporting strategy limits collected metrics
    ...
    def get_flow_metrics_with_http_info(self, producer, **kwargs):
        ...
        all_params = ['producer', 'included_registries', 'sample_name', 'sample_label_value', 'root_field_name', 'flow_metrics_reporting_strategy']
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'flow_metrics_reporting_strategy' in params:
            query_params.append(('flowMetricsReportingStrategy', params['flow_metrics_reporting_strategy']))
    ...
    def get_flow_registry_client_definition(self, group, artifact, version, type, **kwargs):
        """
        ...
        For full HTTP response details (status code, headers, etc.), use the corresponding 
        ``get_flow_registry_client_definition_with_http_info()`` method instead.
        ...
        Args:
            ...
            version (str): 
                The bundle version (required)
            type (str): 
                The flow registry client type (required)
                
        Returns:
            :class:`~nipyapi.nifi.models.FlowRegistryClientDefinition`: The response data.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_flow_registry_client_definition_with_http_info(group, artifact, version, type, **kwargs)
        else:
            (data) = self.get_flow_registry_client_definition_with_http_info(group, artifact, version, type, **kwargs)
            return data

    def get_flow_registry_client_definition_with_http_info(self, group, artifact, version, type, **kwargs):
        """
        Retrieves the Flow Registry Client Definition for the specified component type..
        ...
        Returns the response data along with HTTP status code, headers, and other metadata.
        For just the response data, use the corresponding ``get_flow_registry_client_definition()`` method instead.
        ...
        Returns:
            tuple: (:class:`~nipyapi.nifi.models.FlowRegistryClientDefinition`, status_code, headers) - Response data with HTTP details.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_flow_registry_client_definition" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'group' is set
        if ('group' not in params) or (params['group'] is None):
            raise ValueError("Missing the required parameter `group` when calling `get_flow_registry_client_definition`")
        # verify the required parameter 'artifact' is set
        if ('artifact' not in params) or (params['artifact'] is None):
            raise ValueError("Missing the required parameter `artifact` when calling `get_flow_registry_client_definition`")
        # verify the required parameter 'version' is set
        if ('version' not in params) or (params['version'] is None):
            raise ValueError("Missing the required parameter `version` when calling `get_flow_registry_client_definition`")
        # verify the required parameter 'type' is set
        if ('type' not in params) or (params['type'] is None):
            raise ValueError("Missing the required parameter `type` when calling `get_flow_registry_client_definition`")
        ...
        return self.api_client.call_api('/flow/flow-registry-client-definition/{group}/{artifact}/{version}/{type}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='FlowRegistryClientDefinition',
                                        auth_settings=auth_settings,
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
    ...
    def get_listen_ports(self, **kwargs):
        """
        Gets all listen ports configured on this NiFi that the current user has access to.
        This method makes a synchronous HTTP request and returns the response data directly.
        
        For full HTTP response details (status code, headers, etc.), use the corresponding 
        ``get_listen_ports_with_http_info()`` method instead.
        
        Args:
                
        Returns:
            :class:`~nipyapi.nifi.models.ListenPortsEntity`: The response data.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_listen_ports_with_http_info(**kwargs)
        else:
            (data) = self.get_listen_ports_with_http_info(**kwargs)
            return data

    def get_listen_ports_with_http_info(self, **kwargs):
        """
        Gets all listen ports configured on this NiFi that the current user has access to.
        This method makes a synchronous HTTP request and returns detailed response information.
        
        Returns the response data along with HTTP status code, headers, and other metadata.
        For just the response data, use the corresponding ``get_listen_ports()`` method instead.
        
        Args:
                
        Returns:
            tuple: (:class:`~nipyapi.nifi.models.ListenPortsEntity`, status_code, headers) - Response data with HTTP details.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_listen_ports" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/flow/listen-ports', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ListenPortsEntity',
                                        auth_settings=auth_settings,
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
    ...
    def get_step_documentation(self, group, artifact, version, connector_type, step_name, **kwargs):
        """
        ...
        For full HTTP response details (status code, headers, etc.), use the corresponding 
        ``get_step_documentation_with_http_info()`` method instead.
        ...
        Args:
            ...
            version (str): 
                The bundle version (required)
            connector_type (str): 
                The fully qualified Connector type (required)
            step_name (str): 
                The configuration step name (required)
                
        Returns:
            :class:`~nipyapi.nifi.models.StepDocumentationEntity`: The response data.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_step_documentation_with_http_info(group, artifact, version, connector_type, step_name, **kwargs)
        else:
            (data) = self.get_step_documentation_with_http_info(group, artifact, version, connector_type, step_name, **kwargs)
            return data

    def get_step_documentation_with_http_info(self, group, artifact, version, connector_type, step_name, **kwargs):
        """
        Retrieves the step documentation for the specified Connector configuration step..
        ...
        Returns the response data along with HTTP status code, headers, and other metadata.
        For just the response data, use the corresponding ``get_step_documentation()`` method instead.
        ...
        Returns:
            tuple: (:class:`~nipyapi.nifi.models.StepDocumentationEntity`, status_code, headers) - Response data with HTTP details.
        """

        all_params = ['group', 'artifact', 'version', 'connector_type', 'step_name']
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_step_documentation" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'group' is set
        if ('group' not in params) or (params['group'] is None):
            raise ValueError("Missing the required parameter `group` when calling `get_step_documentation`")
        # verify the required parameter 'artifact' is set
        if ('artifact' not in params) or (params['artifact'] is None):
            raise ValueError("Missing the required parameter `artifact` when calling `get_step_documentation`")
        # verify the required parameter 'version' is set
        if ('version' not in params) or (params['version'] is None):
            raise ValueError("Missing the required parameter `version` when calling `get_step_documentation`")
        # verify the required parameter 'connector_type' is set
        if ('connector_type' not in params) or (params['connector_type'] is None):
            raise ValueError("Missing the required parameter `connector_type` when calling `get_step_documentation`")
        # verify the required parameter 'step_name' is set
        if ('step_name' not in params) or (params['step_name'] is None):
            raise ValueError("Missing the required parameter `step_name` when calling `get_step_documentation`")
        ...
        if 'connector_type' in params:
            path_params['connectorType'] = params['connector_type']
        if 'step_name' in params:
            path_params['stepName'] = params['step_name']
        ...
        return self.api_client.call_api('/flow/steps/{group}/{artifact}/{version}/{connectorType}/{stepName}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='StepDocumentationEntity',
                                        auth_settings=auth_settings,
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
                                        _request_timeout=params.get('_request_timeout'),
    ...
    def search_flow(self, **kwargs):
        ...
        Args:
            q (str): 
                The search term.
            a (str): 
                The id of the currently visited process group. If not specified, then the root process group is used.
