...
class ProcessGroupsApi(object):
    ...
    def export_process_group(self, id, **kwargs):
        ...
        Args:
            ...
            include_component_state (bool): 
                If component state should be included in the exported flow definition. Requires all processors to be stopped and all controller services to be disabled.
    ...
    def export_process_group_with_http_info(self, id, **kwargs):
        ...
        all_params = ['id', 'include_referenced_services', 'include_component_state']
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'include_component_state' in params:
            query_params.append(('includeComponentState', params['include_component_state']))
    ...
    def import_process_group(self, id, **kwargs):
        ...
        Args:
            ...
            body (:class:`~nipyapi.nifi.models.ProcessGroupUploadEntity`): 
                The Process Group Upload import details
