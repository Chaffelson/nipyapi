...
class ProcessgroupsApi(object):
    ...
    def copy_snippet_with_http_info(self, id, body, **kwargs):
        ...
        return self.api_client.call_api('/process-groups/{id}/snippet-instance', 'POST',
                                        ...
                                        response_type='FlowSnippetEntity',
    ...
    def upload_template(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.upload_template(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.upload_template_with_http_info(id, **kwargs)
        else:
            (data) = self.upload_template_with_http_info(id, **kwargs)
            return data
    ...
    def upload_template_with_http_info(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.upload_template_with_http_info(id, callback=callback_function)
