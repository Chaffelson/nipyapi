...
class ControllerServiceReferencingComponentDTO(object):
    ...
    def __init__(self, group_id=None, id=None, name=None, type=None, state=None, properties=None, descriptors=None, validation_errors=None, reference_type=None, active_thread_count=None, reference_cycle=False, referencing_components=None):
        """
