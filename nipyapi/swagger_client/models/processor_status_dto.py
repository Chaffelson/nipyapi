...
class ProcessorStatusDTO(object):
    ...
    def __init__(self, group_id=None, id=None, name=None, type=None, run_status=None,
                 stats_last_refreshed=None, aggregate_snapshot=None, node_snapshots=None):
        """
    ...
    def aggregate_snapshot(self):
        ...
        A status snapshot that represents the aggregate stats of all nodes in the cluster.
    ...
    def node_snapshots(self):
        ...
        A status snapshot for each node in the cluster. If the NiFi instance is a standalone
        instance, rather than a cluster, this may be null.
    ...
    def node_snapshots(self, node_snapshots):
        ...
        A status snapshot for each node in the cluster. If the NiFi instance is a standalone instance,
