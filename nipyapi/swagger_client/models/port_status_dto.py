...
class PortStatusDTO(object):
    ...
    def __init__(self, id=None, group_id=None, name=None, transmitting=False, run_status=None, stats_last_refreshed=None, aggregate_snapshot=None, node_snapshots=None):
        """
